(module $rustsimplesc.wasm
  ...
  (func $_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17he55f486aa2c2014dE (type 2) (param i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $_ZN16fluentbase_codec3evm117_$LT$impl$u20$fluentbase_codec..encoder..Encoder$LT$B$C$_$C$_$C$_$GT$$u20$for$u20$alloy_primitives..bytes_..Bytes$GT$6encode17h3e049c1e03fe278eE.llvm.1203371630092935593 (type 0) (param i32 i32 i32)
    (local i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_ZN16fluentbase_codec5tuple98_$LT$impl$u20$fluentbase_codec..encoder..Encoder$LT$B$C$_$C$_$C$_$GT$$u20$for$u20$$LP$T$C$$RP$$GT$6encode17h0e451ef67663b01cE (type 6) (param i32 i32 i32 i32)
    ...
    i32.const 8
    i32.add
    call $_ZN16fluentbase_codec3evm117_$LT$impl$u20$fluentbase_codec..encoder..Encoder$LT$B$C$_$C$_$C$_$GT$$u20$for$u20$alloy_primitives..bytes_..Bytes$GT$6encode17h3e049c1e03fe278eE.llvm.1203371630092935593
    block  ;; label = @1
      block  ;; label = @2
        local.get 4
        i32.load offset=24
